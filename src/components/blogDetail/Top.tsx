...
import { reactPost, unReactPost } from '~/apis/reaction'
      ...
      { postId: blogDetail.id, reaction: type },
      {
        onSuccess: () => {
          ...
          setPostDetail({
            ...
            reaction: {
              type: type,
              total: isReact ? blogDetail.reaction.total : blogDetail.reaction.total + 1
            }
          })
        },
        onError: (err: any) => {
  ...
  return (
    <div className='top-post-detail'>
      <div className='image-wrapper'>
        <Image src={blogDetail.imageThumbnail || IMAGES.IMAGE_DEFAULT} alt='' width={800} height={800} />
      </div>
      ...
      <div className='post-info'>
        ...
        <div>
          ...
          <div className='post-action'>
            ...
            >
              {!reactionPost ? <IconLike style={{ width: '20px', height: '20px' }} /> : null}
